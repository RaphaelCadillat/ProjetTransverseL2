...
try{
    ...
    $accept_new_friend = $PDO->prepare("UPDATE req_friends SET req_statuts=0 WHERE id_req = :id_get_req");
    $accept_new_friend->execute([
        "id_get_req" => $id_req
    ]);
}
...
header("Location: ../View/Pages/waiting_request.php");